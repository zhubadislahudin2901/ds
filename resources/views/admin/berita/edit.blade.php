    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="judul" class="form-control bg-dark text-white" value="{{ $berita->judul }}"
                    required>
            </div>

            <div class="mb-3">
                <label class="text-white">Tanggal</label>
                <input type="date" name="tanggal" class="form-control bg-dark text-white" value="{{ $berita->tanggal }}"
                    required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="isi" class="form-control bg-dark text-white" rows="5" required>{{ $berita->isi }}</textarea>
            </div>
