...
<ul>
  ...
  <!-- Dropdown Menu -->
  <li class="dropdown {{ Request::is('fasilitas') || Request::is('visimisi') || Request::is('dataguru') ? 'active' : '' }}">
    <a href="#" class="{{ Request::is('fasilitas') || Request::is('visimisi') || Request::is('dataguru') ? 'active' : '' }}">
      <span>Profil</span> <i class="bi bi-chevron-down dropdown-indicator"></i>
    </a>
    <ul>
      <li><a href="{{ url('/fasilitas') }}" class="{{ Request::is('fasilitas') ? 'active' : '' }}">Fasilitas Sekolah</a></li>
      <li><a href="{{ url('/visimisi') }}" class="{{ Request::is('visimisi') ? 'active' : '' }}">Visi Misi</a></li>
